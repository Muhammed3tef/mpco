...
import image1 from "../../../public/image1.svg"; // عدّل المسار حسب مشروعك
 ...
 شركة اللؤلؤ الحديث لصناعة المنظفات هي شركة متخصصة في إنتاج وتصنيع جميع أنواع المنظفات
    ...
    <div className="flex justify-center lg:justify-end flex-1">
      <img
        src={image1}
        className="w-[260px] sm:w-[300px] md:w-[420px] lg:w-[500px] object-contain"
        alt="من نحن"
      />
    </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className="rounded-xl p-6 shadow-md bg-white w-full">
      ...
      <p className="text-gray-700 text-2xl py-2 leading-relaxed">
        توفير حلول تنظيف مبتكرة وموثوقة من خلال تصنيع منتجات فعّالة وآمنة…
      </p>
    </div>
    ...
    <div className="rounded-xl p-6 shadow-md bg-white w-full">
      ...
      <p className="text-gray-700 text-2xl leading-relaxed mb-2">
        دعم العملاء في تطوير علاماتهم التجارية من خلال خدمات التعبئة والتغليف الخاصة.
      </p>
      <p className="text-gray-700 text-2xl leading-relaxed">
        المساهمة في رفع مستوى صناعة المنظفات عبر الالتزام بالمعايير الصحية والبيئية.
      </p>
    </div>
    ...
    <div className="rounded-xl p-6 shadow-md bg-white w-full">
      ...
      <ul className="text-gray-700 text-2xl leading-relaxed space-y-2">
        <li>• الجودة: الالتزام بأعلى معايير الجودة في كل مرحلة.</li>
        <li>• الابتكار: تطوير منتجات تلبي متطلبات السوق.</li>
        <li>• الموثوقية: بناء علاقات طويلة الأمد مع العملاء.</li>
        <li>• الاستدامة: حلول صديقة للبيئة وإنتاج مستدام.</li>
      </ul>
    </div>
